...
public class XxlJobLogDaoTest {
    ...
    public void test(){
        ...
        log.setTriggerTime(new java.sql.Timestamp(Calendar.getInstance().getTime().getTime()));
        ...
        List<Long> ret4 = xxlJobLogDao.findClearLogIds(1, 1, new java.sql.Timestamp(Calendar.getInstance().getTime().getTime()), 100, 100);
