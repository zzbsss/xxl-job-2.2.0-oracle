...
public class XxlJobLogGlueDaoTest {
    ...
    public void test(){
        ...
        logGlue.setAddTime(new java.sql.Timestamp(Calendar.getInstance().getTime().getTime()));
        logGlue.setUpdateTime(new java.sql.Timestamp(Calendar.getInstance().getTime().getTime()));
