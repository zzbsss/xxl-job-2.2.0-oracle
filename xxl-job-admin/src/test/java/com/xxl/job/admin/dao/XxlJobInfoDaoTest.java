...
public class XxlJobInfoDaoTest {
	...
	public void save_load(){
		...
		info.setAddTime(new java.sql.Timestamp(Calendar.getInstance().getTime().getTime()));
		info.setUpdateTime(new java.sql.Timestamp(Calendar.getInstance().getTime().getTime()));
		info.setGlueUpdatetime(new java.sql.Timestamp(Calendar.getInstance().getTime().getTime()));
		...
		info2.setGlueUpdatetime(new java.sql.Timestamp(Calendar.getInstance().getTime().getTime()));
		info2.setChildJobId("1");

		info2.setUpdateTime(new java.sql.Timestamp(Calendar.getInstance().getTime().getTime()));
